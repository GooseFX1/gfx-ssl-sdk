...
* @returns {SwapResult}
*/
module.exports.swap = function(ssl_in, ssl_out, pair, oracles, amount_in, min_out) {
    try {
...
module.exports.OracleRegistry = OracleRegistry;
/**
*/
class SwapResult {
...
const path = require('path').join(__dirname, 'gfx_ssl_wasm_bg.wasm');
