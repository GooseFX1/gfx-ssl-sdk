...
export function __wbg_get_swapresult_amount_in(a: number, b: number): void;
export function __wbg_set_swapresult_amount_in(a: number, b: number, c: number): void;
export function __wbg_get_swapresult_fee_paid(a: number, b: number): void;
export function __wbg_set_swapresult_fee_paid(a: number, b: number, c: number): void;
export function __wbg_get_swapresult_amount_out(a: number, b: number): void;
export function __wbg_set_swapresult_amount_out(a: number, b: number, c: number): void;
